#SEM model PT frequency + multigroup SEM 
...
fit <- sem(model, data = data, ordered = c("Frequency_public_transport"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta")
...
#MUlti Group SEM Age
#Configural model
fit_configural <- sem(model, data = data, ordered = c("Frequency_public_transport"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Age_group2")
...
# Metric invariance
fit_metric <- sem(model, data = data, ordered = c("Frequency_public_transport"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Age_group2", group.equal=c("loadings"))
#summary(fit_metric, standardized = TRUE, fit.measures = TRUE)

save_model_results(fit_metric, "Age_Metric")

# Scalar invariance
fit_scalar <- sem(model, data = data, ordered = c("Frequency_public_transport"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Age_group2", group.equal=c("loadings", "intercepts"))
...
fit_strict <- sem(model, data = data, ordered = c("Frequency_public_transport"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Age_group2", group.equal=c("loadings", "intercepts", "residuals"))
...
#Configural model
fit_configural <- sem(model, data = data, ordered = c("Frequency_public_transport"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Gender")
#summary(fit_configural, standardized = TRUE, fit.measures = TRUE)
...
# Metric invariance
fit_metric <- sem(model, data = data, ordered = c("Frequency_public_transport"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Gender", group.equal=c("loadings"))
#summary(fit_metric, standardized = TRUE, fit.measures = TRUE)

save_model_results(fit_metric, "Gender_Metric")

# Scalar invariance
fit_scalar <- sem(model, data = data, ordered = c("Frequency_public_transport"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Gender", group.equal=c("loadings", "intercepts"))
#summary(fit_scalar, standardized = TRUE, fit.measures = TRUE)

save_model_results(fit_scalar, "Gender_Scalar")

# Strict Factorial Invariance
fit_strict <- sem(model, data = data, ordered = c("Frequency_public_transport"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Gender", group.equal=c("loadings", "intercepts", "residuals"))
#summary(fit_strict, standardized = TRUE, fit.measures = TRUE)
...
#Configural model
fit_configural <- sem(model, data = data, ordered = c("Frequency_public_transport"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Nb_household_group2")
#summary(fit_configural, standardized = TRUE, fit.measures = TRUE)
...
# Metric invariance
fit_metric <- sem(model, data = data, ordered = c("Frequency_public_transport"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Nb_household_group2", group.equal=c("loadings"))
#summary(fit_metric, standardized = TRUE, fit.measures = TRUE)

save_model_results(fit_metric, "Household_Metric")

# Scalar invariance
fit_scalar <- sem(model, data = data, ordered = c("Frequency_public_transport"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Nb_household_group2", group.equal=c("loadings", "intercepts"))
#summary(fit_scalar, standardized = TRUE, fit.measures = TRUE)

save_model_results(fit_scalar, "Household_Scalar")

# Strict Factorial Invariance
fit_strict <- sem(model, data = data, ordered = c("Frequency_public_transport"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Nb_household_group2", group.equal=c("loadings", "intercepts", "residuals"))
#summary(fit_strict, standardized = TRUE, fit.measures = TRUE)
...
#Configural model
fit_configural <- sem(model, data = data, ordered = c("Frequency_public_transport"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Main_travel_mode")
#summary(fit_configural, standardized = TRUE, fit.measures = TRUE)
...
# Metric invariance
fit_metric <- sem(model, data = data, ordered = c("Frequency_public_transport"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Main_travel_mode", group.equal=c("loadings"))
#summary(fit_metric, standardized = TRUE, fit.measures = TRUE)

save_model_results(fit_metric, "Mode_Metric")

# Scalar invariance
fit_scalar <- sem(model, data = data, ordered = c("Frequency_public_transport"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Main_travel_mode", group.equal=c("loadings", "intercepts"))
#summary(fit_scalar, standardized = TRUE, fit.measures = TRUE)

save_model_results(fit_scalar, "Mode_Scalar")

# Strict Factorial Invariance
fit_strict <- sem(model, data = data, ordered = c("Frequency_public_transport"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Main_travel_mode", group.equal=c("loadings", "intercepts", "residuals"))
#summary(fit_strict, standardized = TRUE, fit.measures = TRUE)
...
#Configural model
fit_configural <- sem(model, data = data, ordered = c("Frequency_public_transport"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Cluster")
#summary(fit_configural, standardized = TRUE, fit.measures = TRUE)
...
# Metric invariance
fit_metric <- sem(model, data = data, ordered = c("Frequency_public_transport"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Cluster", group.equal=c("loadings"))
#summary(fit_metric, standardized = TRUE, fit.measures = TRUE)

save_model_results(fit_metric, "Cluster_Metric")

# Scalar invariance
fit_scalar <- sem(model, data = data, ordered = c("Frequency_public_transport"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Cluster", group.equal=c("loadings", "intercepts"))
#summary(fit_scalar, standardized = TRUE, fit.measures = TRUE)

save_model_results(fit_scalar, "Cluster_Scalar")

# Strict Factorial Invariance
fit_strict <- sem(model, data = data, ordered = c("Frequency_public_transport"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Cluster", group.equal=c("loadings", "intercepts", "residuals"))
#summary(fit_strict, standardized = TRUE, fit.measures = TRUE)
...
#Configural model
fit_configural <- sem(model, data = data, ordered = c("Frequency_public_transport"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Income_group")
#summary(fit_configural, standardized = TRUE, fit.measures = TRUE)
...
# Metric invariance
fit_metric <- sem(model, data = data, ordered = c("Frequency_public_transport"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Income_group", group.equal=c("loadings"))
#summary(fit_metric, standardized = TRUE, fit.measures = TRUE)

save_model_results(fit_metric, "Income_Metric")

# Scalar invariance
fit_scalar <- sem(model, data = data, ordered = c("Frequency_public_transport"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Income_group", group.equal=c("loadings", "intercepts"))
#summary(fit_scalar, standardized = TRUE, fit.measures = TRUE)

save_model_results(fit_scalar, "Income_Scalar")

# Strict Factorial Invariance
fit_strict <- sem(model, data = data, ordered = c("Frequency_public_transport"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Income_group", group.equal=c("loadings", "intercepts", "residuals"))
#summary(fit_strict, standardized = TRUE, fit.measures = TRUE)
