...
#select neighbourhoods from cluster 1

library(dplyr)

selected_rows <- data %>%
  filter(Neighbourhood %in% c("Binnenstad", "MachariusHeirnis", "Elisabethbegijnhof  Prinsenhof  Papegaai  SintMIchiels", "Rabot  Blaisantvest", "Dampoort", "Sluizeken  Tolhuis  Ham","StationsbuurtNoord", "StationsbuurtZuid" ))
