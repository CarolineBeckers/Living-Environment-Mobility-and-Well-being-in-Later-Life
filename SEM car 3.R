#SEM model car frequency + multigroup SEM 
...
#Redefining clusters of neighbourhoods for multigroup SEM (model failed)
data$Cluster[data$Cluster == "Cluster4"] <- "Cluster3"
...
#Redefining mode groups (model failed)
data <- data %>%
  mutate(Mode_group = case_when(
    Main_travel_mode %in% c("Bike", "On foot") ~ "Active",
    Main_travel_mode %in% c("Private car", "Public transport") ~ "Motorised"
  ))
...
#Frequency_car ~ Built_environment + Social_environment

#Frequency_car ~ Qualitative_cycling_infrastructure + Cycling_friendly_environment + Qualitative_public_transport + Encouragement_for_PA + Satisfaction_with_events_in_neighbourhood
#Frequency_car ~ No_walking_friendly_environment + Cycling_friendly_environment + Negative_parking_experiences + Qualitative_public_transport + Attractive_living_environment + Satisfaction_with_friendships_in_neighbourhood
Frequency_car ~ Poor_walking_infrastructure + No_walking_friendly_environment + Qualitative_cycling_infrastructure + Traffic_safety + Negative_parking_experiences + Encouragement_for_PA + Satisfaction_with_events_in_neighbourhood

#Wellbeing ~ Frequency_car
...
Health_related_wellbeing ~ Frequency_car
#Mental_health ~ Frequency_car
...
#EQ_5D_index ~ Frequency_car
#Stress ~ Frequency_car
#No_self_esteem ~ Frequency_car
#Successful_coping ~ Frequency_car
...
fit <- sem(model, data = data, ordered = c("Frequency_car"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta")
...
#MUlti Group SEM Age
#Configural model
fit_configural <- sem(model, data = data, ordered = c("Frequency_car"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Age_group2")
...
# Metric invariance
fit_metric <- sem(model, data = data, ordered = c("Frequency_car"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Age_group2", group.equal=c("loadings"))
#summary(fit_metric, standardized = TRUE, fit.measures = TRUE)

save_model_results(fit_metric, "Age_Metric")

# Scalar invariance
fit_scalar <- sem(model, data = data, ordered = c("Frequency_car"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Age_group2", group.equal=c("loadings", "intercepts"))
...
fit_strict <- sem(model, data = data, ordered = c("Frequency_car"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Age_group2", group.equal=c("loadings", "intercepts", "residuals"))
...
#Configural model
fit_configural <- sem(model, data = data, ordered = c("Frequency_car"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Gender")
#summary(fit_configural, standardized = TRUE, fit.measures = TRUE)
...
# Metric invariance
fit_metric <- sem(model, data = data, ordered = c("Frequency_car"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Gender", group.equal=c("loadings"))
#summary(fit_metric, standardized = TRUE, fit.measures = TRUE)

save_model_results(fit_metric, "Gender_Metric")

# Scalar invariance
fit_scalar <- sem(model, data = data, ordered = c("Frequency_car"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Gender", group.equal=c("loadings", "intercepts"))
#summary(fit_scalar, standardized = TRUE, fit.measures = TRUE)

save_model_results(fit_scalar, "Gender_Scalar")

# Strict Factorial Invariance
fit_strict <- sem(model, data = data, ordered = c("Frequency_car"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Gender", group.equal=c("loadings", "intercepts", "residuals"))
#summary(fit_strict, standardized = TRUE, fit.measures = TRUE)
...
#Configural model
fit_configural <- sem(model, data = data, ordered = c("Frequency_car"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Nb_household_group2")
#summary(fit_configural, standardized = TRUE, fit.measures = TRUE)
...
# Metric invariance
fit_metric <- sem(model, data = data, ordered = c("Frequency_car"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Nb_household_group2", group.equal=c("loadings"))
#summary(fit_metric, standardized = TRUE, fit.measures = TRUE)

save_model_results(fit_metric, "Household_Metric")

# Scalar invariance
fit_scalar <- sem(model, data = data, ordered = c("Frequency_car"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Nb_household_group2", group.equal=c("loadings", "intercepts"))
#summary(fit_scalar, standardized = TRUE, fit.measures = TRUE)

save_model_results(fit_scalar, "Household_Scalar")

# Strict Factorial Invariance
fit_strict <- sem(model, data = data, ordered = c("Frequency_car"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Nb_household_group2", group.equal=c("loadings", "intercepts", "residuals"))
#summary(fit_strict, standardized = TRUE, fit.measures = TRUE)
...
#Configural model
fit_configural <- sem(model, data = data, ordered = c("Frequency_car"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Main_travel_mode")
#summary(fit_configural, standardized = TRUE, fit.measures = TRUE)
...
# Metric invariance
fit_metric <- sem(model, data = data, ordered = c("Frequency_car"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Main_travel_mode", group.equal=c("loadings"))
#summary(fit_metric, standardized = TRUE, fit.measures = TRUE)

save_model_results(fit_metric, "Mode_Metric")

# Scalar invariance
fit_scalar <- sem(model, data = data, ordered = c("Frequency_car"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Main_travel_mode", group.equal=c("loadings", "intercepts"))
#summary(fit_scalar, standardized = TRUE, fit.measures = TRUE)

save_model_results(fit_scalar, "Mode_Scalar")

# Strict Factorial Invariance
fit_strict <- sem(model, data = data, ordered = c("Frequency_car"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Main_travel_mode", group.equal=c("loadings", "intercepts", "residuals"))
#summary(fit_strict, standardized = TRUE, fit.measures = TRUE)
...
#MUlti Group SEM travel mode (active VS motorised modes)
#Configural model
fit_configural <- sem(model, data = data, ordered = c("Frequency_car"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Mode_group")
#summary(fit_configural, standardized = TRUE, fit.measures = TRUE)
...
# Metric invariance
fit_metric <- sem(model, data = data, ordered = c("Frequency_car"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Mode_group", group.equal=c("loadings"))
#summary(fit_metric, standardized = TRUE, fit.measures = TRUE)

save_model_results(fit_metric, "Mode_Metric")

# Scalar invariance
fit_scalar <- sem(model, data = data, ordered = c("Frequency_car"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Mode_group", group.equal=c("loadings", "intercepts"))
#summary(fit_scalar, standardized = TRUE, fit.measures = TRUE)

save_model_results(fit_scalar, "Mode_Scalar")

# Strict Factorial Invariance
fit_strict <- sem(model, data = data, ordered = c("Frequency_car"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Mode_group", group.equal=c("loadings", "intercepts", "residuals"))
#summary(fit_strict, standardized = TRUE, fit.measures = TRUE)
...
#Configural model
fit_configural <- sem(model, data = data, ordered = c("Frequency_car"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Cluster")
#summary(fit_configural, standardized = TRUE, fit.measures = TRUE)
...
# Metric invariance
fit_metric <- sem(model, data = data, ordered = c("Frequency_car"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Cluster", group.equal=c("loadings"))
#summary(fit_metric, standardized = TRUE, fit.measures = TRUE)

save_model_results(fit_metric, "Cluster_Metric")

# Scalar invariance
fit_scalar <- sem(model, data = data, ordered = c("Frequency_car"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Cluster", group.equal=c("loadings", "intercepts"))
#summary(fit_scalar, standardized = TRUE, fit.measures = TRUE)

save_model_results(fit_scalar, "Cluster_Scalar")

# Strict Factorial Invariance
fit_strict <- sem(model, data = data, ordered = c("Frequency_car"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Cluster", group.equal=c("loadings", "intercepts", "residuals"))
#summary(fit_strict, standardized = TRUE, fit.measures = TRUE)
...
#Configural model
fit_configural <- sem(model, data = data, ordered = c("Frequency_car"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Income_group")
#summary(fit_configural, standardized = TRUE, fit.measures = TRUE)
...
# Metric invariance
fit_metric <- sem(model, data = data, ordered = c("Frequency_car"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Income_group", group.equal=c("loadings"))
#summary(fit_metric, standardized = TRUE, fit.measures = TRUE)

save_model_results(fit_metric, "Income_Metric")

# Scalar invariance
fit_scalar <- sem(model, data = data, ordered = c("Frequency_car"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Income_group", group.equal=c("loadings", "intercepts"))
#summary(fit_scalar, standardized = TRUE, fit.measures = TRUE)

save_model_results(fit_scalar, "Income_Scalar")

# Strict Factorial Invariance
fit_strict <- sem(model, data = data, ordered = c("Frequency_car"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Income_group", group.equal=c("loadings", "intercepts", "residuals"))
#summary(fit_strict, standardized = TRUE, fit.measures = TRUE)
