#SEM model cycling frequency + multigroup SEM 
...
#Frequency_bike ~ Built_environment + Social_environment

Frequency_bike ~ Qualitative_cycling_infrastructure + Cycling_friendly_environment + Qualitative_public_transport + Encouragement_for_PA + Satisfaction_with_events_in_neighbourhood
#Frequency_bike ~ No_walking_friendly_environment + Cycling_friendly_environment + Negative_parking_experiences + Qualitative_public_transport + Attractive_living_environment + Satisfaction_with_friendships_in_neighbourhood

#Wellbeing ~ Frequency_bike
...
Health_related_wellbeing ~ Frequency_bike
#Mental_health ~ Frequency_bike
...
#EQ_5D_index ~ Frequency_bike
#Stress ~ Frequency_bike
#No_self_esteem ~ Frequency_bike
#Successful_coping ~ Frequency_bike
...
fit <- sem(model, data = data, ordered = c("Frequency_bike"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta")
...
table(data$Nb_household_group) #more than 2 people is too low (47) --> together with two-person household
...
#MUlti Group SEM Age
#Configural model
fit_configural <- sem(model, data = data, ordered = c("Frequency_bike"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Age_group2")
...
# Metric invariance
fit_metric <- sem(model, data = data, ordered = c("Frequency_bike"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Age_group2", group.equal=c("loadings"))
#summary(fit_metric, standardized = TRUE, fit.measures = TRUE)

save_model_results(fit_metric, "Age_Metric")

# Scalar invariance
fit_scalar <- sem(model, data = data, ordered = c("Frequency_bike"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Age_group2", group.equal=c("loadings", "intercepts"))
...
fit_strict <- sem(model, data = data, ordered = c("Frequency_bike"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Age_group2", group.equal=c("loadings", "intercepts", "residuals"))
...
#Configural model
fit_configural <- sem(model, data = data, ordered = c("Frequency_bike"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Gender")
#summary(fit_configural, standardized = TRUE, fit.measures = TRUE)
...
# Metric invariance
fit_metric <- sem(model, data = data, ordered = c("Frequency_bike"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Gender", group.equal=c("loadings"))
#summary(fit_metric, standardized = TRUE, fit.measures = TRUE)

save_model_results(fit_metric, "Gender_Metric")

# Scalar invariance
fit_scalar <- sem(model, data = data, ordered = c("Frequency_bike"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Gender", group.equal=c("loadings", "intercepts"))
#summary(fit_scalar, standardized = TRUE, fit.measures = TRUE)

save_model_results(fit_scalar, "Gender_Scalar")

# Strict Factorial Invariance
fit_strict <- sem(model, data = data, ordered = c("Frequency_bike"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Gender", group.equal=c("loadings", "intercepts", "residuals"))
#summary(fit_strict, standardized = TRUE, fit.measures = TRUE)
...
#Configural model
fit_configural <- sem(model, data = data, ordered = c("Frequency_bike"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Nb_household_group2")
#summary(fit_configural, standardized = TRUE, fit.measures = TRUE)
...
# Metric invariance
fit_metric <- sem(model, data = data, ordered = c("Frequency_bike"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Nb_household_group2", group.equal=c("loadings"))
#summary(fit_metric, standardized = TRUE, fit.measures = TRUE)

save_model_results(fit_metric, "Household_Metric")

# Scalar invariance
fit_scalar <- sem(model, data = data, ordered = c("Frequency_bike"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Nb_household_group2", group.equal=c("loadings", "intercepts"))
#summary(fit_scalar, standardized = TRUE, fit.measures = TRUE)

save_model_results(fit_scalar, "Household_Scalar")

# Strict Factorial Invariance
fit_strict <- sem(model, data = data, ordered = c("Frequency_bike"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Nb_household_group2", group.equal=c("loadings", "intercepts", "residuals"))
#summary(fit_strict, standardized = TRUE, fit.measures = TRUE)
...
#Configural model
fit_configural <- sem(model, data = data, ordered = c("Frequency_bike"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Main_travel_mode")
#summary(fit_configural, standardized = TRUE, fit.measures = TRUE)
...
# Metric invariance
fit_metric <- sem(model, data = data, ordered = c("Frequency_bike"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Main_travel_mode", group.equal=c("loadings"))
#summary(fit_metric, standardized = TRUE, fit.measures = TRUE)

save_model_results(fit_metric, "Mode_Metric")

# Scalar invariance
fit_scalar <- sem(model, data = data, ordered = c("Frequency_bike"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Main_travel_mode", group.equal=c("loadings", "intercepts"))
#summary(fit_scalar, standardized = TRUE, fit.measures = TRUE)

save_model_results(fit_scalar, "Mode_Scalar")

# Strict Factorial Invariance
fit_strict <- sem(model, data = data, ordered = c("Frequency_bike"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Main_travel_mode", group.equal=c("loadings", "intercepts", "residuals"))
#summary(fit_strict, standardized = TRUE, fit.measures = TRUE)
...
#Configural model
fit_configural <- sem(model, data = data, ordered = c("Frequency_bike"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Cluster")
#summary(fit_configural, standardized = TRUE, fit.measures = TRUE)
...
# Metric invariance
fit_metric <- sem(model, data = data, ordered = c("Frequency_bike"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Cluster", group.equal=c("loadings"))
#summary(fit_metric, standardized = TRUE, fit.measures = TRUE)
# modification indices to check possible differences in latent constructs (factor loadings) (MI > 10)
mi_metric <- modificationIndices(fit_metric)
#subset(mi_metric, op == "=~" & mi > 10)

mi_metric %>%
  filter(op == "=~", mi > 10) %>%
  arrange(desc(mi))

#Only showing mi's for relationships specified in our model
model_specification_pairs <- c(
  "Poor_walking_infrastructure =~ Walkable_with_walker_or_wheelchair",
  "Poor_walking_infrastructure =~ Maintained_sidewalks",
  "Poor_walking_infrastructure =~ Little_obstacles_on_sidewalks",
  "Poor_walking_infrastructure =~ Easy_to_cross_streets",
  
  "No_walking_friendly_environment =~ Walking_friendly_neighbourhood",
  "No_walking_friendly_environment =~ Enough_benches",
  "No_walking_friendly_environment =~ Enough_greenery",
  "No_walking_friendly_environment =~ Public_spaces_are_pleasant_meeting_places",
  
  "Qualitative_cycling_infrastructure =~ Qualitative_cycling_lanes",
  "Qualitative_cycling_infrastructure =~ Maintained_cycling_infrastructure",
  "Qualitative_cycling_infrastructure =~ Sufficient_cycling_infrastructure",
  "Qualitative_cycling_infrastructure =~ Maintained_streets_._squares",
  
  "Cycling_friendly_environment =~ Cyclingfriendly_neighbourhood",
  "Cycling_friendly_environment =~ Enjoyable_cycling",
  "Cycling_friendly_environment =~ Feeling_safe_in_traffic_as_cyclist",
  "Cycling_friendly_environment =~ Busy_traffic_causing_unsafe_cycling_experiences",
  
  "Busy_traffic =~ A_lot_of_traffic",
  "Busy_traffic =~ A_lot_of_freight_traffic",
  "Busy_traffic =~ Nuisance_due_to_traffic",
  "Busy_traffic =~ Few_traffic_accidents",
  
  "Traffic_safety =~ Enough_public_lighting",
  "Traffic_safety =~ Feeling_safe_in_traffic_as_pedestrian",
  "Traffic_safety =~ Feeling_safe_in_traffic_as_car_user",
  "Traffic_safety =~ Feeling_safe_on_public_transport",
  
  "Negative_parking_experiences =~ Accessible_by_car",
  "Negative_parking_experiences =~ Easily_finding_parking_spots_for_residents",
  "Negative_parking_experiences =~ Easily_finding_parking_spots_for_visitors",
  
  "Qualitative_public_transport =~ Satisfied_with_public_transport",
  "Qualitative_public_transport =~ Enough_public_transport",
  "Qualitative_public_transport =~ Sufficiently_frequent_public_transport",
  "Qualitative_public_transport =~ Well_equipped_public_transport_stops",
  "Qualitative_public_transport =~ Accessible_public_transport_stops",
  "Qualitative_public_transport =~ Enough_seats_on_public_transport",
  "Qualitative_public_transport =~ Easy_to_find_information_on_public_transport_for_older_people",
  
  "Neighbourhood_social_cohesion =~ I_know_my_neighbours_well",
  "Neighbourhood_social_cohesion =~ Friendships_and_relationships_in_neighbourhood_mean_a_lot",
  "Neighbourhood_social_cohesion =~ Chat_regularly_with_neighbours",
  "Neighbourhood_social_cohesion =~ Regular_visitings_of_neighbours",
  "Neighbourhood_social_cohesion =~ Neighbours_are_willing_to_help_each_other",
  "Neighbourhood_social_cohesion =~ I_can_go_to_neighbours_if_I_need_advise",
  "Neighbourhood_social_cohesion =~ Neighbours_would_help_in_emergency",
  "Neighbourhood_social_cohesion =~ I_often_borrow_things_to_neighbours",
  "Neighbourhood_social_cohesion =~ My_neighbours_are_trustworthy",
  "Neighbourhood_social_cohesion =~ My_neighbours_get_along",
  "Neighbourhood_social_cohesion =~ My_neighbourhood_is_close.knit",
  "Neighbourhood_social_cohesion =~ Living_in_this_neighbourhood_gives_a_sense_of_community",
  
  "Attractive_living_environment =~ I_live_in_a_attractive_neighbourhood",
  "Attractive_living_environment =~ I_feel_like_I_belong_to_this_neighbourhood",
  "Attractive_living_environment =~ I_would_like_to_move_given_the_opportunity",
  "Attractive_living_environment =~ Planning_to_live_here_for_several_years",
  "Attractive_living_environment =~ Good_place_to_bring_up_children",
  
  "Encouragement_for_PA =~ I_can_count_on_people_to_be_physically_active_with_me",
  "Encouragement_for_PA =~ Family_and_friends_encourage_me_to_be_active",
  "Encouragement_for_PA =~ People_important_to_me_encourage_me_to_participate_in_physical_activities",
  "Encouragement_for_PA =~ Family_and_friends_participate_in_physical_activities_regularly",
  "Encouragement_for_PA =~ Seeing_other_participating_in_physical_activities_makes_me_want_to_participate",
  
  "Satisfaction_with_friendships_in_neighbourhood =~ Satisfied_with_number_of_friends",
  "Satisfaction_with_friendships_in_neighbourhood =~ Visit_friends_at_their_place",
  "Satisfaction_with_friendships_in_neighbourhood =~ Satisfied_with_number_of_people_I_know_in_neighbourhood",
  
  "Satisfaction_with_events_in_neighbourhood =~ Older_adults_are_informed_about_activities",
  "Satisfaction_with_events_in_neighbourhood =~ Sufficient_activities_are_aimed_at_or_adapted_to_older_adults",
  "Satisfaction_with_events_in_neighbourhood =~ Activities_are_easily_accessible",
  "Satisfaction_with_events_in_neighbourhood =~ Older_adults_are_sufficiently_involved_in_the_organisation_of_activities",
  
  "Health_related_wellbeing =~ EQ_5D_index",
  "Health_related_wellbeing =~ VAS",
  "Health_related_wellbeing =~ Activity_rate_compared_to_peers",
  
  "Built_environment =~ Poor_walking_infrastructure",
  "Built_environment =~ No_walking_friendly_environment",
  "Built_environment =~ Qualitative_cycling_infrastructure",
  "Built_environment =~ Cycling_friendly_environment",
  "Built_environment =~ Busy_traffic",
  "Built_environment =~ Traffic_safety",
  "Built_environment =~ Negative_parking_experiences",
  "Built_environment =~ Qualitative_public_transport",
  
  "Social_environment =~ Neighbourhood_social_cohesion",
  "Social_environment =~ Attractive_living_environment",
  "Social_environment =~ Encouragement_for_PA",
  "Social_environment =~ Satisfaction_with_friendships_in_neighbourhood",
  "Social_environment =~ Satisfaction_with_events_in_neighbourhood"
)
...
mi_metric %>%
  filter(
    op == "=~",
    paste(lhs, "=~", rhs) %in% model_specification_pairs,
    mi > 1
  ) %>%
  arrange(desc(mi))
...
# Scalar invariance
fit_scalar <- sem(model, data = data, ordered = c("Frequency_bike"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Cluster", group.equal=c("loadings", "intercepts"))
#summary(fit_scalar, standardized = TRUE, fit.measures = TRUE)

save_model_results(fit_scalar, "Cluster_Scalar")

# Strict Factorial Invariance
fit_strict <- sem(model, data = data, ordered = c("Frequency_bike"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Cluster", group.equal=c("loadings", "intercepts", "residuals"))
#summary(fit_strict, standardized = TRUE, fit.measures = TRUE)
...
#Configural model
fit_configural <- sem(model, data = data, ordered = c("Frequency_bike"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Income_group")
#summary(fit_configural, standardized = TRUE, fit.measures = TRUE)
...
# Metric invariance
fit_metric <- sem(model, data = data, ordered = c("Frequency_bike"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Income_group", group.equal=c("loadings"))
#summary(fit_metric, standardized = TRUE, fit.measures = TRUE)

save_model_results(fit_metric, "Income_Metric")

# Scalar invariance
fit_scalar <- sem(model, data = data, ordered = c("Frequency_bike"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Income_group", group.equal=c("loadings", "intercepts"))
#summary(fit_scalar, standardized = TRUE, fit.measures = TRUE)

save_model_results(fit_scalar, "Income_Scalar")

# Strict Factorial Invariance
fit_strict <- sem(model, data = data, ordered = c("Frequency_bike"), std.ov = TRUE, estimator = "WLSMV", parameterization = "theta", group = "Income_group", group.equal=c("loadings", "intercepts", "residuals"))
#summary(fit_strict, standardized = TRUE, fit.measures = TRUE)
